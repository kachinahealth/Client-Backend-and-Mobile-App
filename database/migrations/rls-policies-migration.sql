...
-- News Updates: Users can see news in trials they're assigned to
-- Admin: SELECT all news in their organization
-- User: SELECT news in assigned trials
-- Doctor: SELECT news in assigned trials
