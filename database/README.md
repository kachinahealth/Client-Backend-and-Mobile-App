...
- **Users**: admin@companya.com, user@companya.com, admin@companyb.com, doctor@companya.com
- **Clinical Trials**: Trial A, Trial B
- **Assignments**: user@companya.com & doctor@companya.com → Trial A
...
```sql
-- Should see all company trials
SELECT name FROM clinical_trials;

-- Should see all company users
